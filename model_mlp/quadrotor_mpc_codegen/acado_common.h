 ...
 * 
 *  Matrix containing 20 reference/measurement vectors of size 24 for first 20 nodes.
 */
real_t y[ 480 ];
...
/** Matrix of size: 480 x 24 (row major format) */
real_t W[ 11520 ];
...
{
/** Column vector of size: 1097854 */
real_t rhs_aux[ 1097854 ];
...
/** Matrix of size: 280 x 24 (row major format) */
real_t Q2[ 6720 ];

/** Matrix of size: 160 x 8 (row major format) */
real_t R1[ 1280 ];

/** Matrix of size: 160 x 24 (row major format) */
real_t R2[ 3840 ];

/** Matrix of size: 14 x 14 (row major format) */
real_t QN1[ 196 ];

/** Matrix of size: 14 x 16 (row major format) */
real_t QN2[ 224 ];
...
/** Matrix of size: 14 x 8 (row major format) */
real_t W1[ 112 ];

/** Matrix of size: 14 x 8 (row major format) */
real_t W2[ 112 ];

/** Matrix of size: 2940 x 8 (row major format) */
real_t E[ 23520 ];
...
/** Matrix of size: 80 x 160 (row major format) */
real_t A[ 12800 ];
